; 2020-02-19 17:23 :: zenAndroid ::  Hello again, in this specofoc file and in
; the later ones as well, I think I will turn to racket as it provides the
; `stream-cons` procedure
...
;; NOW ONTO THE ACTUAL EXERCISE, FINALLY
...
(define factorials
  (stream-cons 1 (mul-streams (stream-rest integers)
                              factorials)))
